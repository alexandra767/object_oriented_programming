    ...
    def add_song(self, song, position=None):
        ...
        Args:
            ...
            position (Optional[int]): If specified, the song will be added to that position
                ...
                Otherwise, song will be added to the end of list.
        """
...
class Artist:
    ...
    Attributes:
        ...
        albums (List[Album]): A list of the albums by this artist.
            ...
            not an exhaustive List of those artist's published albums.
    Methods:
    ...
    def add_song(self, name, year, title):
        ...
        A new album will be creatred in the collection if it doesn't already exist.
